...
# vecterized S[n,m]
size_basis = 585 # num_spcetra =585 
...
np.save('result_D3_qns_theta', QNS_theta)
np.save('result_D3_qns_n', QNS_n)
np.save('result_D3_qns_rho', QNS_rho)
np.save('result_D3_qns_Matrix', obs_to_S_matrix)
