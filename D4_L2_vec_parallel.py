...
def control_dynamics (i):
    """
    It is actually dyson expansion with control specified
    ...
    tmp_01 = D1_01(i)+D2_01(i)+D3_01(i)+D4_01(i)
    tmp_10 = D1_10(i)+D2_10(i)+D3_10(i)+D4_10(i)
    tmp_11 = D1_11(i)+D2_11(i)+D3_11(i)+D4_11(i)
...
print("d2",datetime.now().strftime("%H:%M:%S"))
D2_00(10)
print("d3",datetime.now().strftime("%H:%M:%S"))
D3_01(10)
print("d4",datetime.now().strftime("%H:%M:%S"))
D4_01(10)
...
np.save('result_D4_qns_theta', QNS_theta)
np.save('result_D4_qns_n', QNS_n)
np.save('result_D4_qns_rho', QNS_rho)
np.save('result_D4_qns_Matrix', obs_to_S_matrix)
